    ...
    <div class="page-heading">
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('dulieudanhmuc.quanhuyen') }}">Thông tin quận, huyện, thị xã</a></li>
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('dulieudanhmuc.quanhuyen-create-post') }}" method="POST">
                        @csrf
                        @if ($errors->any())
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="tenhuyen">Tên quận, huyện, thị xã <span class="text-require">*</span></label>
                                    <input type="text" class="form-control" id="tenhuyen" name="tenhuyen" value="{{ old('tenhuyen') }}">
                                </div>
                                <div class="form-group">
