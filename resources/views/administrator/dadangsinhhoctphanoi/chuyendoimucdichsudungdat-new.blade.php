    ...
    <div class="page-heading">
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('dadangsinhhochanoi.chuyenmucdichsudungdat') }}">Chuyển đổi mục đích sử dụng đất</a></li>
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('dadangsinhhochanoi.chuyenmucdichsudungdat-create-post') }}" method="POST">
                        @csrf
                        @if ($errors->any())
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="tenduan">Tên dự án <span class="text-require">*</span></label>
                                    <input type="text" class="form-control" id="tenduan" name="tenduan" value="{{ old('tenduan') }}" required>
                                </div>
                            </div>
                        </div>
