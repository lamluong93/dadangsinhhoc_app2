    ...
    <div class="page-heading">
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('dadangsinhhochanoi.thongso') }}">Danh mục thông số</a></li>
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('dadangsinhhochanoi.thongso-create-post') }}" method="POST">
                        @csrf
                        @if ($errors->any())
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="chithi_id">Chỉ thị <span class="text-require">*</span></label>
                                    <select class="form-control" name="chithi_id">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="tenthongso" name="tenthongso" value="{{ old('tenthongso') }}">
                                </div>
                                <div class="form-group">
