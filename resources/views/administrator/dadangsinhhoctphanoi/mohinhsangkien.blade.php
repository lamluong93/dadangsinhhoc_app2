                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Mô hình sáng kiến</li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <div class="col-md-4">
                                <div class="card-header">
                                    <div class="d-flex justify-content-end">
                                        <a href="{{ route('dadangsinhhochanoi.mohinhsangkien-create') }}"><button class="btn btn-outline-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle-fill" viewBox="0 0 16 16">
                                ...
                                <table class="table table-hover table-bordered mb-0 font-size-14">
                                    <thead>
                                        <tr class="table-primary text-center">
                                            ...
                                            <th style="width: 10%">Tên mô hình sáng kiến</th>
                                            <th>Hình thức sáng kiến</th>
                                            <th>Nội dung</th>
                                            <th>Tổ chức</th>
                                            <th>Địa điểm tổ chức</th>
                                            <th>Thời gian bắt đầu</th>
                                            <th>Thời gian kết thúc</th>
                                            <th>Kết quả áp dụng</th>
                                            <th>Ghi chú</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $item->ten }}</td>
                                            @php
                                                $v1 = \App\Models\DefValue::select('giatri')->where('id', $item->hinhthuc)->get()
                                            @endphp
                                            <td>
                                                @if ( count($v1) )
                                                    {{ $v1[0]->giatri }}
                                            ...
                                            <td>{!! $item->noidung !!}</td>
                                            @php
                                                $tc = \App\Models\ToChuc::select('ten')->where('id', $item->coquan_id)->get()
                                            @endphp
                                            <td>
                                                @if ( count($tc) )
                                                    {{ $tc[0]->ten }}
