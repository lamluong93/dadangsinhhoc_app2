    ...
    <div class="page-heading">
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('dulieudadangsinhhoc.loainguongen') }}">Loại nguồn gen</a></li>
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('dulieudadangsinhhoc.loainguongen-create-post') }}" method="POST">
                        @csrf
                        @if ($errors->any())
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="nhomnguongen">Nhóm nguồn gen <span class="text-require">*</span></label>
                                    <select class="form-control" name="nhomnguongen" id="nhomnguongen">
                                        <option value="">--Lựa chọn--</option>
                                        @foreach($nhom as $i)
                                            <option value="{{$i->id}}">{{$i->nhomnguongen}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="ten">Tên loại nguồn gen <span class="text-require">*</span></label>
