                ...
                <div class="testi-carousel owl-carousel owl-theme">
                    <div class="testimonial clearfix">
                        ...
                        <div class="testi-meta">
                            <img src="{{ asset('front/images/testi_01.png') }}" alt="" class="img-fluid">
                    ...
                    <div class="testimonial clearfix">
                        ...
                        <div class="testi-meta">
                            <img src="{{ asset('front/images/testi_02.png') }}" alt="" class="img-fluid">
                    ...
                    <div class="testimonial clearfix">
                        ...
                        <div class="testi-meta">
                            <img src="{{ asset('front/images/testi_03.png') }}" alt="" class="img-fluid ">
                            <h4>Venanda Mercy </h4>
                        </div>
                        <!-- end testi-meta -->
                    </div>
